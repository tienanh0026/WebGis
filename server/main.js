...
app.post('/api/get-geometry-vietnam/district-new', (req,res) =>{
    ...
    var b= "select id_1,name_1,id_2, name_2,type_2,ST_XMin(ST_Collect(geom))*15 as xmin,ST_XMax(ST_Collect(geom))*15 as xmax, ST_YMin(ST_Collect(geom))*-15 as ymin,ST_YMax(ST_Collect(geom))*-15 as ymax, st_assvg(geom) from vnm_adm2 group by id_1,name_1,id_2,name_2,type_2,geom having ";
    var c = b.concat(a)
    console.log(c);
    //console.log(c);
...
app.post('/api/get-geometry-vietnam/province-new', (req,res) =>{
    ...
    ' and (ST_YMax(ST_Collect(geom))*-15-abs((ST_YMax(ST_Collect(geom))-ST_YMin(ST_Collect(geom))))*-15/2) >',ymin,
    ' and (ST_YMax(ST_Collect(geom))*-15-abs((ST_YMax(ST_Collect(geom))-ST_YMin(ST_Collect(geom))))*-15/2) <',ymax)
    var b= "select id_1,name_1,type_1,ST_XMin(ST_Collect(geom))*15 as xmin,ST_XMax(ST_Collect(geom))*15 as xmax, ST_YMin(ST_Collect(geom))*-15 as ymin,ST_YMax(ST_Collect(geom))*-15 as ymax, st_assvg(geom) from vnm_adm1 group by id_1,name_1,type_1, geom having ";
    var c = b.concat(a);
    //console.log(c);
    //console.log(c);
    ...
    app.post('/api/get-geometry-vietnam/communes-new', (req,res) =>{
        ...
        ' and (ST_YMax(ST_Collect(geom))*-15-abs((ST_YMax(ST_Collect(geom))-ST_YMin(ST_Collect(geom))))*-15/2) >',ymin,
        ' and (ST_YMax(ST_Collect(geom))*-15-abs((ST_YMax(ST_Collect(geom))-ST_YMin(ST_Collect(geom))))*-15/2) <',ymax)
        var b= "select id_2,name_2,id_3, name_3,type_3,ST_XMin(ST_Collect(geom))*15 as xmin,ST_XMax(ST_Collect(geom))*15 as xmax, ST_YMin(ST_Collect(geom))*-15 as ymin,ST_YMax(ST_Collect(geom))*-15 as ymax, st_assvg(geom) from vnm_adm3 group by id_2,name_2,id_3,name_3,type_3,geom having ";
        var c = b.concat(a)
        //console.log(c);
        //console.log(c);
        client.query(c, (err, result) => {
...
app.get('/api/get-geometry-vietnam/province_bbox', (req, res) => {
    ...
    client.query(`select id_1,name_1,ST_Area(ST_Transform(geom, 2044))/1000000 As area ,ST_XMin(ST_Collect(geom))*15 as xmin,ST_XMax(ST_Collect(geom))*15 as xmax,
...
app.get('/api/get-geometry-vietnam/district_bbox', (req, res) => {
    ...
    client.query(`select id_1,name_1,id_2, name_2,type_2,ST_Area(ST_Transform(geom, 2044))/1000000 As area,ST_XMin(ST_Collect(geom))*15 as xmin,ST_XMax(ST_Collect(geom))*15 as xmax,
    ...
    app.get('/api/get-geometry-vietnam/commune_bbox', (req, res) => {
        ...
        client.query(`select id_1,name_1,id_2, name_2,id_3,name_3,type_3,ST_Area(ST_Transform(geom, 2044))/1000000 As area,ST_XMin(ST_Collect(geom))*15 as xmin,ST_XMax(ST_Collect(geom))*15 as xmax,
